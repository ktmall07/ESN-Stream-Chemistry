...
res3 = respy.nodes.Reservoir(units=10000, lr=0.9)

read1 = respy.nodes.Ridge(ridge=1e-7)
read2 = respy.nodes.Ridge(ridge=1e-7)
read3 = respy.nodes.Ridge(ridge=1e-7)
...
print("Reservoir Sizes: 100, 1000, 10000")
print("RMSE: " + str([small_rmse, med_rmse, large_rmse]))
